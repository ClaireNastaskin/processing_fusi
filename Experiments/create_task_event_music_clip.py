...
base_path = Path('/Users/clairenastaskin/data/2025-07-08/sub-Forest001_ses-20250708_task-movements_run-005')  

start_clip_tsv_path = base_path / 'sub-Forest001_ses-20250708_task-movements_run-005_events.tsv'
start_clip_tsv_file = pd.read_csv(start_clip_tsv_path, sep='\t')

task_tsv_path = base_path / 'clip5_events.tsv'
